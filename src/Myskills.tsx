...
const Myskills = () => {
  return (
    <div className=" bg-[#161616] h-[100vh] w-[100%]  ">
        <div className="flex gap-10 " data-aos='slide-left' data-aos-delay='1200'>
     <div className="bg-[#161616] shadow-xl h-[60px] w-[25%] ml-[50px] mt-[50px] flex gap-4" >
      ...
      <div className="flex gap-10" data-aos='slide-right' data-aos-delay='1200'>
      <div className="bg-[#161616] shadow-xl h-[60px] w-[25%] ml-[50px] mt-[50px] flex gap-4" >
     ...
     <div className="bg-[#161616] shadow-xl h-[60px] w-[25%] ml-[50px] mt-[50px] flex gap-4" >
      ...
      <div className="flex justify-center mr-[50px] mt-[90px]" data-aos='slide-right' data-aos-delay='1200'>
