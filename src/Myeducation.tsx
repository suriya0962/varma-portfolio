  ...
  return (
        ...
        <div className='bg-[#161616] md:h-[100vh] h-[100%] w-[100%] mt-[20px] ' >
         <div className="bg-[#161616] shadow-xl md:h-[120px] h-[50px] w-[100%] md:ml-[50px]  ml-[5px] flex gap-4" data-aos='slide-right' data-aos-delay='1000' >
                ...
                className="md:h-[90px] h-[30px] md:w-[60px] w-[20px] md:mt-[13px] mt-[7px]"/>
                </div>
                <div className="">
                <h1 
                className="text-white  md:text-[30px] text-[15px]">School Education</h1>
                <p className="text-white  md:text-[15px] text-[5px]  ">I studied my school education upto 10th standard in Bhashyam public school in viazainagarm</p>
                <p className="text-white  md:text-[15px]  text-[5px]">I completed my 10th class eduation with 8.7 cgpa</p>
             </div>
            </div>
            <div className="bg-[#161616] shadow-xl md:h-[120px] h-[50px] w-[100%] md:ml-[50px] ml-[5px] md:mt-[50px] mt-[20px] flex gap-4" data-aos='slide-left' data-aos-delay='1000' >
          
          <div>
        <img src='https://cdn-icons-png.flaticon.com/512/8074/8074808.png'
          className="md:h-[90px] h-[30px] bg-white md:w-[60px] w-[20px] md:mt-[13px] mt-[1px]"/>
          </div>
          <div className=" ">
          <h1 className="text-white  md:text-[30px] text-[15px] ">Intermediate Education</h1>
          <p className="text-white  md:text-[15px]  text-[5px]">I studied my intermediate eduation  in narayana junior college in viazainagarm</p>
          <p className="text-white  md:text-[15px] text-[5px] ">I completed my inter eduation with 80 percentage</p>
       </div>
      </div>
      <div className="bg-[#161616] shadow-xl md:h-[120px] h-[50px] w-[100%] md:ml-[50px] ml-[5px] md:mt-[50px] mt-[20px] flex gap-4" data-aos='slide-right' data-aos-delay='1000'>
          
          <div>
        <img src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT59CpqPxet4aQSLztIerfAjF7qyS6LfuAS8Q&usqp=CAU'
          className="md:h-[90px] h-[30px] bg-white md:w-[60px] w-[20px] md:mt-[13px] mt-[5px]"/>
          </div>
          <div className=" ">
          <h1 className="text-white  md:text-[30px] text-[15px] ">Engeneering Graduation</h1>
          <p className="text-white  md:text-[15px]  text-[5px]">I studied bachalore of technology in information technology department  in M.v.g.r college of engeneering in viazainagarm</p>
          <p className="text-white  md:text-[15px]  text-[5px]">I completed my graduation with 6.2 cgpa</p>
       </div>
      </div>
         </div>
